...
\rhead{}
\lfoot{
\cfoot{\scriptsize  Jonathan A. Nations - CV }}
...
\hypersetup{unicode=true,
            pdftitle={Jonathan A. Nations:  CV (Curriculum Vitae)},
            pdfauthor={Jonathan A. Nations},
...
\centerline{\huge \bf Jonathan A. Nations}
...
\moveleft.5\hoffset\centerline{NSF Postdoctoral Research Fellow}

\moveleft.5\hoffset\centerline{University of Chicago \textbar{} Field
Museum of Natural History}
\moveleft.5\hoffset\centerline{ \faEnvelopeO \hspace{1 mm} \href{mailto:}{\tt \href{mailto:jonnations@gmail.com}{\nolinkurl{jonnations@gmail.com}}} \hspace{1 mm}  \faGithub \hspace{1 mm} \href{http://github.com/jonnations}{\tt jonnations} \hspace{1 mm}     \faGlobe \hspace{1 mm} \href{http://jonnynations.com}{\tt jonnynations.com}    | \emph{Updated:} \apstylekinda\today} 
...
\hypertarget{education-research-positions}{%
\section{Education \& Research
Positions}\label{education-research-positions}}

\emph{Department of the Geophysical Sciences, University of Chicago}
\hfill Chicago, IL

\emph{Mammals Division, Field Museum of Natural History} \hfill 

Postdoctoral Researcher \hfill March 2021 - present

Researcher (Dublin) \hfill 1899-1935 Editing in Visual editor.

\textbf{trying some more visual editor,} \uline{underlining some stuff
then} \texttt{trying\ the\ code\ button\ \textless{}/\textgreater{}}.
pretty slick.
